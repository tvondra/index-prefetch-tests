...
explain select * from btree_test where a = $v;
...
EOF
		...
		echo "btree" $t $r $n $q master uncached $e $v >> $RESULTS 2>&1
...
EOF
		...
		echo "btree" $t $r $n $q master cached $e $v >> $RESULTS 2>&1
...
EOF
		...
		echo "btree" $t $r $n $q patched uncached $e $v >> $RESULTS 2>&1
...
EOF
		...
		echo "btree" $t $r $n $q patched cached $e $v >> $RESULTS 2>&1
...
EOF
		...
		echo "btree" $t $r $n $q bitmapscan uncached $e $v >> $RESULTS 2>&1
...
EOF
		...
		echo "btree" $t $r $n $q bitmapscan cached $e $v >> $RESULTS 2>&1
...
EOF
		...
		echo "btree" $t $r $n $q seqscan uncached $e $v >> $RESULTS 2>&1
...
EOF
		...
		echo "btree" $t $r $n $q seqscan cached $e $v >> $RESULTS 2>&1
