...
EOF
		...
		echo "gist-distance" $t $r $n $n master uncached $e $x $y >> $RESULTS 2>&1
...
EOF
		...
		echo "gist-distance" $t $r $n $n master cached $e $x $y >> $RESULTS 2>&1
...
EOF
		...
		echo "gist-distance" $t $r $n $n patched uncached $e $x $y >> $RESULTS 2>&1
...
EOF
		...
		echo "gist-distance" $t $r $n $n patched cached $e $x $y >> $RESULTS 2>&1
...
EOF
		...
		echo "gist-distance" $t $r $n $n seqscan uncached $e $x $y >> $RESULTS 2>&1
...
EOF
		...
		echo "gist-distance" $t $r $n $n seqscan cached $e $x $y >> $RESULTS 2>&1
