...
EOF
		...
		echo "spgist" $t $r $n $q master uncached $e $x1 $y1 $x2 $y2 >> $RESULTS 2>&1
...
EOF
		...
		echo "spgist" $t $r $n $q master cached $e $x1 $y1 $x2 $y2 >> $RESULTS 2>&1
...
EOF
		...
		echo "spgist" $t $r $n $q patched uncached $e $x1 $y1 $x2 $y2 >> $RESULTS 2>&1
...
EOF
		...
		echo "spgist" $t $r $n $q patched cached $e $x1 $y1 $x2 $y2 >> $RESULTS 2>&1
...
EOF
		...
		echo "spgist" $t $r $n $q bitmapscan uncached $e $x1 $y1 $x2 $y2 >> $RESULTS 2>&1
...
EOF
		...
		echo "spgist" $t $r $n $q bitmapscan cached $e $x1 $y1 $x2 $y2 >> $RESULTS 2>&1
...
EOF
		...
		echo "spgist" $t $r $n $q seqscan uncached $e $x1 $y1 $x2 $y2 >> $RESULTS 2>&1
...
EOF
		...
		echo "spgist" $t $r $n $q seqscan cached $e $x1 $y1 $x2 $y2 >> $RESULTS 2>&1
